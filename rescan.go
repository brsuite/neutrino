...
type ChainSource interface {
	...
	GetBlock(chainhash.Hash, ...QueryOption) (*bronutil.Block, error)
...
func WatchAddrs(watchAddrs ...bronutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *headerfs.BlockStamp, filter *gcs.Filter) ([]*bronutil.Tx,
	error) {
	...
	relevantTxs := make([]*bronutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *bronutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *bronutil.Tx) (bool, error) {
...
// replacement for the brond rescan and notification functionality used in
...
func AddAddrs(addrs ...bronutil.Address) UpdateOption {
