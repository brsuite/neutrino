...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*bronutil.Block
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, bronutil.NewBlock(&Block99999))

	block100000Hash := Block100000.BlockHash()
	mockChainClient.SetBlockHash(100000, &block100000Hash)
	mockChainClient.SetBlock(&block100000Hash, bronutil.NewBlock(&Block100000))
...
// The following is taken from the brsuite/bronutil project.
